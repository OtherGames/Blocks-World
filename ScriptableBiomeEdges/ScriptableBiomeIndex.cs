...
public class ScriptableBiomeIndex : ScriptableObject
{
    ...
    public virtual void Init(string biomeName = "")
    {
        min =  999999f;
        max = -999999f;
    ...
    public virtual BiomePointData GetBiomeNoise(float x, float y, float z, Biome biome, float biomeScale, float globalBiomeThresold)
    {
...
public enum BiomeThresholdedType
{
    Default,
    Border,
    Biomos
